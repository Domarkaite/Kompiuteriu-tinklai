...
int main() {
    ...
    struct ConnectToServerArgs args1 = {22223, 22228};
    struct ConnectToServerArgs args2 = {22225, 22229};
    sleep(20);
    pthread_create(&thread1, NULL, connectToServer, (void *)&args1);
    pthread_create(&thread2, NULL, connectToServer, (void *)&args2);
    ...
    while (1) {
        ...
        if (ntohs(clientAddr.sin6_port) == 22227)
        {
            pthread_t thread;
